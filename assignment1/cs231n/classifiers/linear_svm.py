...
def svm_loss_vectorized(W, X, y, reg):
    ...
    scores = X.dot(W)
    correct_class_scores = np.expand_dims(scores[row_inds, y], axis=1)
    ...
    #############################################################################
    # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
    # draw detailed computational graph with small example
    # then you can compute analytical gradient correctly
